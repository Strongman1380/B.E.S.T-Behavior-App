              ...
              return `
                <tr>
                  ...
                  <td style="border:1px solid #000; padding:10px; vertical-align:top; text-align:center; width:18%; font-size:16px; font-weight:700; letter-spacing:2px;">
                    ${[1,2,3,4].map(n => `<span style=\"display:inline-block; width:22px; height:22px; line-height:18px; text-align:center; border-radius:50%; border:2px solid ${'${selected===n?\'#000\':\'transparent\'}'}; margin:0 6px; font-weight:700;\">${n}</span>`).join('')}
                  </td>
